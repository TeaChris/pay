...
import { roles, permissions, rolePermissions } from '../../infrastructure/db/schema/index.js';
...
import { DEFAULT_ROLES, DEFAULT_PERMISSIONS, ROLE_PERMISSION_MAP } from './rbac.constants.js';
