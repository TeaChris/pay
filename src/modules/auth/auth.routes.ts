    ...
    return c.json(
      {
        ...
        data: {
          ...
          // In production, the token would be sent via email, not in response
          // Included here for API testing and development
  ...
  async (c) => {
    ...
    return c.json({
      ...
      data: {
        ...
        // In production, token sent via email only. Exposed here for dev/testing.
